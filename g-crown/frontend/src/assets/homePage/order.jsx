...
import GoldEaring from "../../assets/orderSuccess/GoldEaring.jpg";
import GoldEaring2 from "../../assets/orderSuccess/GoldEaring2.jpg";
import GoldEaring3 from "../../assets/orderSuccess/GoldEaring3.jpg";
import GoldEaring4 from "../../assets/orderSuccess/GoldEaring.jpg";
import FootIcon from "../../assets/orderSuccess/FootIcon.png";
import FootIcon2 from "../../assets/orderSuccess/FootIcon2.png";
import FootIcon3 from "../../assets/orderSuccess/FootIcon3.png";
  ...
  return (
    <main className="bg-[#FFF8E8] min-h-screen py-20">
      <div className="max-w-[900px] mx-auto px-4">
        ...
        {/* ORDER META BAR */}
        <div className="mt-10 bg-[#1C3A2C] rounded-md flex flex-wrap justify-between items-center text-white text-sm px-6 py-4 gap-4">
          <div>
            <p className="text-xs opacity-70 text-[17px]">Order ID</p>
            <p className="font-medium text-[15px]">SSICTT456AD</p>
          </div>

          <div>
            <p className="text-xs opacity-70 text-[17px]">Payment Method</p>
            <p className="font-medium text-[15px]">Paypal</p>
          </div>

          <div>
            <p className="text-xs opacity-70 text-[17px]">Transaction ID</p>
            <p className="font-medium text-[15px]">SSICTT456AD</p>
          </div>

          <div>
            <p className="text-xs opacity-70 text-[17px]">
              Estimated Delivery Date
            </p>
            <p className="font-medium text-[15px]">24 December 2025</p>
          </div>

          <button className="bg-[#C9A14A] text-[#FFFFFF] px-4 py-2 rounded text-sm font-medium hover:opacity-90">
            Download Invoice
          </button>
        </div>
